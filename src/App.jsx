        ...
        {(view === "stock" || view === "config") && (
          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", marginBottom: "16px" }}>
            {FLOORS.map(f => {
              ...
              return (
                <button key={f.id} onClick={() => setFloor(f.id)} style={{ padding: "6px 14px", borderRadius: "20px", border: "1px solid", borderColor: floor === f.id ? "#fff" : "#333", background: floor === f.id ? "#fff" : "transparent", color: floor === f.id ? "#000" : "#777", fontSize: "12px", cursor: "pointer", fontFamily: "inherit" }}>
                  {f.label}{hasAlert ? " ⚠️" : ""}
                </button>
              );
            })}
